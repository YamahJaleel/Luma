  ...
  const settingsSections = [
    ...
    },
    {
      ...
      items: [
           ...
           id: 'about_luma',
           title: 'About Luma',
           subtitle: 'Learn more about Luma',
           icon: 'information-outline',
           type: 'navigate',
         },
        {
    ...
    if (item.type === 'toggle') {
      return (
        <List.Item
          ...
          left={(props) => <List.Icon {...props} icon={item.icon || 'help-circle-outline'} color="#3E5F44" />}
          ...
          right={() => (
            <Switch
              ...
              trackColor={{ false: '#E2E8F0', true: '#3E5F44' }}
