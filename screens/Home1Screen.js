...
const MOCK_POSTS = [
  { id: 'p1', score: 45, type: 'experience', title: 'Red Flag Alert', author: 'u/alex', category: 'red-flags', text: 'Controlling behavior warning', comments: 12, created: '2h', url: '', votes: {}, views: 321 },
  { id: 'p2', score: 23, type: 'question', title: 'Advice Needed', author: 'u/sam', category: 'dating-advice', text: 'Is asking location normal?', comments: 8, created: '4h', url: '', votes: {}, views: 210 },
  { id: 'p3', score: 67, type: 'positive', title: 'Success Story', author: 'u/jane', category: 'success-stories', text: 'Found my person!', comments: 15, created: '1d', url: '', votes: {}, views: 589 },
  { id: 'p4', score: 34, type: 'question', title: 'First Date Tips', author: 'u/lily', category: 'dating-advice', text: 'How to keep convo flowing?', comments: 18, created: '1h', url: '', votes: {}, views: 145 },
  { id: 'p5', score: 78, type: 'warning', title: 'Love Bombing Alert', author: 'u/max', category: 'red-flags', text: 'Manipulation tactic', comments: 31, created: '30m', url: '', votes: {}, views: 802 },
];
  ...
  return (
    <TouchableOpacity activeOpacity={0.9} onPress={onPress}>
      ...
      <View style={styles.postFooter}>
        <View style={{ flex: 1 }} />
        <Text style={[styles.postMeta, { color: theme.dark ? theme.colors.text : '#6B7280' }]}>{item.comments} comments</Text>
      </View>
      </View>
    </TouchableOpacity>
  );
