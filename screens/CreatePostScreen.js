...
const styles = StyleSheet.create({
  ...
  input: { borderRadius: 10, backgroundColor: 'transparent', paddingHorizontal: 12, paddingVertical: 12, borderWidth: 1, borderColor: '#E5E7EB' },
  textarea: { borderRadius: 10, backgroundColor: 'transparent', paddingHorizontal: 12, paddingVertical: 12, borderWidth: 1, borderColor: '#E5E7EB', minHeight: 140 },
