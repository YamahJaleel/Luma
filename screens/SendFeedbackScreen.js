      ...
      <LinearGradient colors={theme.dark ? ['#1F2937', '#111827'] : ['#FAF6F0', '#F5F1EB']} style={styles.gradient}>
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.welcomeSection}>
            <View style={styles.iconCircle}><Ionicons name="chatbubbles" size={32} color="#FFFFFF" /></View>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={[styles.inputWrapper, { backgroundColor: theme.colors.surface }]}>
              <TextInput value={category} onChangeText={setCategory} placeholder="Category (e.g., UI, Performance)" placeholderTextColor={theme.colors.placeholder} style={[styles.textInput, { color: theme.colors.text }]} />
            </View>

            <Text style={[styles.label, { color: theme.colors.text }]}>Feedback</Text>
            <View style={[styles.inputWrapper, { backgroundColor: theme.colors.surface }]}>
              <TextInput value={message} onChangeText={setMessage} placeholder="Share your feedback" placeholderTextColor={theme.colors.placeholder} style={[styles.textAreaInput, { color: theme.colors.text }]} multiline numberOfLines={6} textAlignVertical="top" />
            </View>
          </View>

          <TouchableOpacity style={[styles.primaryBtn, !message.trim() && styles.primaryBtnDisabled]} onPress={sendEmail} disabled={!message.trim()}>
...
const styles = StyleSheet.create({
  ...
  textAreaInput: { fontSize: 16, minHeight: 140 },
